...
<body>
	...
	<h1>도서 목록</h1>
	<div>
		<a class=hanker href=/book/bookreturn?userid=<sec:authentication property="principal.member.userid"/>>도서 반납</a>
	...
	<table class=tbl>
		...
		<c:forEach items="${list }" var="book">
			<tr>
				<td><a class="tanker" href='/book/getchk?isbn=${book.isbn }'>${book.title}</a></td>
				<td>${book.author }</td>
				<td>${book.category }</td>
