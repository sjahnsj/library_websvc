...
<body>
	...
	<main>
		<form action="/book/modify" method="post" accept-charset="utf-8">
			...
			<label>제목</label> 
			<input type="text" required name="title" value="${book.title }" />
			<label>저자</label> 
			<input type="text" required name="author" value="${book.author }" />
			<label for = "issueyear">발행연도</label> 
			<input  id="issueyear" type="number" required name="issueyear" value="${book.issueyear }" /> 
